...
MODEL_PARAM = {
    ...
    "pre_trained_tmae_path": "baselines/ST-DC05-all/mask_save/Mask_TMAE_STDC05_PEMSBAY_best_val_loss.pt",
    "pre_trained_smae_path": "baselines/ST-DC05-all/mask_save/Mask_SMAE_STDC05_PEMSBAY_best_val_MAE.pt",
    "mask_args": {
                    "patch_size":12,
                    "in_channel":1,
                    "embed_dim":96,
