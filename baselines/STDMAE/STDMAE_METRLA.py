...
MODEL_ARCH = STDMAE
adj_mx, _ = load_adj("datasets/" + DATA_NAME + "/adj_mx_process.pkl", "doubletransition")
MODEL_PARAM = {
    "dataset_name": DATA_NAME,
    "pre_trained_tmae_path": "baselines/STDMAE/mask_save/Mask_TMAE_best_val_loss.pt",
    "pre_trained_smae_path": "baselines/STDMAE/mask_save/Mask_SMAE_best_val_MAE.pt",
    "mask_args": {
                    "patch_size":12,
                    "in_channel":1,
                    "embed_dim":96,
