...
from .arch import STDC05Ablation
...
MODEL_ARCH = STDC05Ablation
adj_mx, _ = load_adj("datasets/" + DATA_NAME + "/adj_mx.pkl", "doubletransition")
MODEL_PARAM = {
    "dataset_name": DATA_NAME,
    "pre_trained_tmae_path": "baselines/ST-DC05-Ablation/mask_save/Mask_TMAE_noagcrn_best_val_loss.pt",
    "pre_trained_smae_path": "baselines/ST-DC05-Ablation/mask_save/Mask_SMAE_noagcrn_best_val_MAE",
    "mask_args": {
                    "patch_size":12,
                    "in_channel":1,
                    "embed_dim":96,
